        ...
        <div className={cn("flex gap-2 h-1/10 p-2", {
            ...
            <Dialog>
                <DialogTrigger asChild>
                    <Button className="w-[10px] bg-[#011627] hover:bg-[#36c5b3]"><Upload />
                    </Button>
                </DialogTrigger>
                <DialogContent className="flex flex-col bg-[#0E2232] border-none text-white h-[85%]">
                    ...
                    <div className="flex flex-col items-center gap-4 w-full h-full">
                        ...
                        <div className="flex flex-row w-5/6 h-1/6 justify-end gap-2">
                            <Button className="bg-[#011627] hover:bg-[#36c5b3]">Cancel</Button>
                            <Button className="bg-[#36c5b3] hover:bg-[#278f81]">Import Test Cases</Button>
                        </div>
                        <div className="flex flex-col justify-center items-center w-5/6 gap-4 h-2/6">
                            ...
                            <table className="w-full border-collapse text-xs">
                                <thead>
                                    <tr>
                                        <th className="border border-[#3C2F66] bg-[#1E2744] p-1 text-left font-medium">name</th>
                                        <th className="border border-[#3C2F66] bg-[#1E2744] p-1 text-left font-medium">prompt</th>
                                        <th className="border border-[#3C2F66] bg-[#1E2744] p-1 text-left font-medium">expectedOutput</th>
                                        <th className="border border-[#3C2F66] bg-[#1E2744] p-1 text-left font-medium">models</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td className="border border-[#3C2F66] p-1">Test 1</td>
                                        <td className="border border-[#3C2F66] p-1">What is the capital of France?</td>
                                        <td className="border border-[#3C2F66] p-1">Paris is the capital of France.</td>
                                        <td className="border border-[#3C2F66] p-1">gpt-4;claude-3</td>
                                    </tr>
                                    <tr>
                                        <td className="border border-[#3C2F66] p-1">Test 2</td>
                                        <td className="border border-[#3C2F66] p-1">Explain quantum computing</td>
                                        <td className="border border-[#3C2F66] p-1">Quantum computing uses quantum bits...</td>
                                        <td className="border border-[#3C2F66] p-1">gpt-4;gpt-3.5;gemini-pro</td>
                                    </tr>
                                    <tr>
                                        <td className="border border-[#3C2F66] p-1">Test 3</td>
                                        <td className="border border-[#3C2F66] p-1">Write a haiku about nature</td>
                                        ...
                                        <td className="border border-[#3C2F66] p-1">llama-3;mistral</td>
                                    </tr>
                                </tbody>
                            </table>
                            <div className="flex flex-col gap-2 w-full text-start">
                                <p className="text-xs">
                                    Note: In the actual CSV file, values with commas or line breaks should be enclosed in double quotes. For the models column, use semicolons to separate multiple model IDs.
                                </p>
                                <p className="text-xs">
                                    Available model IDs: gpt-4, gpt-3.5, claude-3, gemini-pro, llama-3, mistral
                                </p>
                            </div>
                        </div>
